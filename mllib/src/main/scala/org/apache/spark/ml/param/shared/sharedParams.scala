...
private[ml] trait HasMaxIter extends Params {
   ...
   * @group param
   */
  final val maxIter: IntParam = new IntParam(this, "maxIter", "maximum number of iterations (>= 0)", ParamValidators.gtEq(0)) ////校验条件是int的属性值,并且属性值>=0
...
private[ml] trait HasLabelCol extends Params {
   ...
   * @group param
   */
  final val labelCol: Param[String] = new Param[String](this, "labelCol", "label column name") //字符串属性
